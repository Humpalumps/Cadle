...
// ---------------------------------------------------------------- per-biome data
// fog/grade colours are LINEAR-ish sRGB hexes the Sky grades toward; `fogMul` scales FogExp2 density.
// ground: splat driver weights (see Terrain FRAG_SPLAT) — which layer the region's floor is made of.
// grass:  { d } density multiplier 0..1 applied on top of the terrain grass mask, { tint } linear multiplier.
// enemies: camp roster [type, count, rMin, rMax]; `level` is the band the region's mobs spawn at.
export const BIOMES = {
  meadow: {
    k: -1, name: 'The Vale', short: 'Meadow', zone: 'meadow', level: [1, 5],
    fog: 0xa8c4de, fogMul: 1.0, sun: 0xffffff, amb: 1.0,
    grass: { d: 1.0, tint: 0xffffff },
  ...
  forest: {
    ...
    ground: 'forest', grass: { d: 0.85, tint: 0x9fd4a8 },
  ...
  tundra: {
    ...
    ground: 'snow', grass: { d: 0.10, tint: 0xa8c0d8 },
  ...
  celestial: {
    ...
    ground: 'stone', grass: { d: 0.20, tint: 0xd8e8c0 },
  ...
  dragon: {
    ...
    ground: 'rock', grass: { d: 0.18, tint: 0xa8b090 },
  ...
  infernal: {
    ...
    ground: 'ash', grass: { d: 0, tint: 0x000000 }, lava: true,
  ...
  lost: {
    ...
    ground: 'stone', grass: { d: 0.35, tint: 0xc0b8d8 },
  ...
  shadowfen: {
    ...
    ground: 'muck', grass: { d: 0.55, tint: 0x7a8a58 },
  ...
  sunken: {
    ...
    ground: 'sand', grass: { d: 0.05, tint: 0x6a9a90 }, sea: true,
  ...
  void: {
    ...
    fog: 0x2c2040, fogMul: 1.25, sun: 0xc0a0ff, amb: 0.6,
    ground: 'voidstone', grass: { d: 0, tint: 0x000000 }, dry: true, float: true, gravity: 0.55,
