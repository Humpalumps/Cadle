...
export const DEFS = {
  ...
  autorifle: {
    ...
    kick: { pitch: 0.006, yaw: 0.0035, vz: 0.7, vx: 3.4, roll: 1.4, yawV: 0.8, k: 320, c: 24, pattern: true }, shake: 0.08,
  ...
  pulse: {
    ...
    kick: { pitch: 0.0055, yaw: 0.003, vz: 0.65, vx: 3.4, roll: 1.2, yawV: 0.6, k: 330, c: 24 }, shake: 0.1,
  ...
  sniper: {
    ...
    kick: { pitch: 0.032, yaw: 0.01, vz: 2.6, vx: 10.0, roll: 3.0, yawV: 1.2, k: 150, c: 14 }, shake: 0.5,
...
export const DEFAULT_SLOTS = ['handcannon', 'autorifle'];   // starting kit: pistol + rifle. Two slots only (user call 2026-08-21)
